...
export function Step1(
  ...
  if (step === 1) {
    return (
      <div key="step1" className={cn("flex flex-col gap-4 mt-10")}>
        ...
        <p>
          Directions: Type commands in manualy, copy and paste, or just click
          the &quot;Send request&quot; button under each step. Leave the{" "}
          <span className=" text-white">&lt;token&gt;</span> tag for now.
          Normally you would put your root key here. We will handle any rootkey
...
export function Step2(
  ...
  if (step === 2) {
    return (
      <div key="step2" className={cn("flex flex-col gap-4 mt-12 w-full")}>
        <h2>Get Key Data</h2>
...
export function Step3(
  ...
  if (step === 3) {
    return (
      <div
        key="step3"
        className={cn("flex flex-col gap-4 mt-12 w-full")}
      >
        <h2>Verify Key</h2>
...
export function Step4(
  ...
  return (
    <div key="step4" className={cn("flex flex-col gap-4 mt-12 w-full")}>
      <h2>Update Key</h2>
      <p>{stepData[4].blurb}</p>
      <p>
        ownerId: <span className="my-2 text-white">user_1234</span>
      </p>
      <p>
        keyId: <span className="my-2 text-white">{keyId}</span>
      </p>
...
export function Step5(
  ...
  if (step === 5) {
  return (
    <div key="step5" className={cn("flex flex-col gap-4 mt-12 w-full")}>
      <h2>Verify Key</h2>
      ...
      <p>
        Key name: <span className="my-2 text-white">{keyName}</span>
      </p>
      <div className="my-8">
        <CodeBlock className="">{renderString}</CodeBlock>
      </div>
...
export function Step6(
  ...
  return (
    <div key="step6" className={cn("flex flex-col gap-4 mt-12 w-full")}>
      <h2>Update expiration</h2>
      <p>{stepData[6].blurb}</p>
      <p>
        Expiration: <span className="my-2 text-white">{timeStamp}</span>
      </p>
      <p>
        keyId: <span className="my-2 text-white">{keyId}</span>
      </p>
      <p>
        url: <span className="my-2 text-white">{stepData[6].url}</span>
      </p>
      <p>headers:</p>
      <p className="pl-4">
      ...
      <p>
        method:{" "}
        <span className="my-2 text-white">{stepData[6].method}</span>
      </p>
      <div className="my-8">
        <CodeBlock className="">{renderString}</CodeBlock>
      </div>
...
export function Step7(
  ...
  return (
    <div key="step7" className={cn("flex flex-col gap-4 mt-12 w-full")}>
      <h2>Verify Key</h2>
...
export function Step8(
  ...
  return (
    <div key="step8" className={cn("flex flex-col gap-4 mt-12 w-full")}>
      <h2> Verify Key</h2>
...
export function Step9(
  ...
  return (
    <div key="step9" className={cn("flex flex-col gap-4 mt-12 w-full")}>
      <h1>Delete Key</h1>
...
export function Step10(
  ...
  return (
    <div key="step10" className={cn("flex flex-col gap-4 mt-12 w-full")}>
      <h1>Verify Key</h1>
      <p>{stepData[10].blurb}</p>
      <p>
        apiId: <span className="my-2 text-white">{apiId}</span>
      </p>
      <p>
        key: <span className="my-2 text-white">{keyName}</span>
      </p>
      <div className="my-8">
        <CodeBlock>{renderString}</CodeBlock>
      </div>
